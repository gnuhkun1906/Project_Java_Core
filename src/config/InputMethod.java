...
public class InputMethod {
    private static final String ERROR_ALERT = "===>> The number you entered does not match, please try again....";
    private static final String EMPTY_ALERT = "===>> Please do not leave it blank,try again....";
